...
function animate() {
  ...
  tl.addLabel('start', 0)
    ...
    .to(['#copy1, #cta'], 0.5, { autoAlpha: 1 }, '-=0.25')
    .to(['#copy1'], 0.2, { autoAlpha: 0 }, '+=2.5')

    .to(['#copy2,#terms0'], 0.3, { autoAlpha: 1 }, '+=0')
    .to(['#copy2,#terms0'], 0.1, { autoAlpha: 0 }, '+=2.5')


    .to('#topPanel, #pinkBar', 0.5, { y: "-=182" })

    .to('#cta', 0.3, { scale: 1.1, ease: Power1.easeInOut, rotationZ: 0.1, force3D: true }, '+=.5')
    .to('#cta', 0.3, { scale: 1.0, ease: Power1.easeInOut, rotationZ: 0.1, force3D: true }, '+=0')
